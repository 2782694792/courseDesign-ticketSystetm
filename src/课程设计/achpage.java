...
public class achpage extends JFrame  implements ActionListener{
	private static final long serialVersionUID = 1L;
		...
		void conductor0() {
			jl6 = new JLabel();
			jl6.setBounds(0, 0, 576, 500);
		    
			//车次输入框
			jl61 = new JLabel("工       号：");
			jl61.setBounds(20, 160, 70, 20);
			concon = new JTextField(10);
			concon.setBounds(90, 160, 150, 20);
			//车次修改框
			jl661 = new JLabel("改  为：");
			jl661.setBounds(265, 160, 70, 20);
			concon1 = new JTextField(10);
			concon1.setBounds(325, 160, 150, 20);
			//车次清空按钮
			conreset1 = new JButton("清空");
			conreset1.setBounds(486, 160, 70, 20);
			conreset1.setForeground(Color.GREEN);
			conreset1.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {     // 车次清空
					concon.setText("");
					concon1.setText("");
				}
			...
			//座位数输入框
		    jl62 = new JLabel("姓       名：");
		    jl62.setBounds(20, 190, 70, 20);
		    conname = new JTextField(10);
		    conname.setBounds(90, 190, 150, 20);
			//座位数修改框
			jl662 = new JLabel("改  为：");
			jl662.setBounds(265, 190, 70, 20);
			conname1 = new JTextField(10);
			conname1.setBounds(325, 190, 150, 20);
			//座位数清空按钮
			conreset2 = new JButton("清空");
			conreset2.setBounds(486, 190, 70, 20);
			conreset2.setForeground(Color.GREEN);
			conreset2.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {       // 座位数清空
					conname.setText("");
					conname1.setText("");
				}
			...
			//负责人输入框
		    jl63 = new JLabel("性       别：");
		    jl63.setBounds(20, 220, 70, 20);
			consex = new JTextField(10);
			consex.setBounds(90, 220, 150, 20);
			//负责人修改框
			jl663 = new JLabel("改  为：");
			jl663.setBounds(265, 220, 70, 20);
			consex1 = new JTextField(10);
			consex1.setBounds(325, 220, 150, 20);
			//清空按钮
			conreset3 = new JButton("清空");
			conreset3.setBounds(486, 220, 70, 20);
			conreset3.setForeground(Color.GREEN);
		    conreset3.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {     // 负责人清空
					consex.setText("");
					consex1.setText("");
				}
			...
			//添加按钮
			concreate = new JButton("修改");
			concreate.setBounds(168, 280, 70, 30);
			//登录判断事件
			concreate.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {    
					concreate.setBackground(Color.blue);     // 黑色清空
		            conductor1();
				}
			});
			
			//清空按钮
			conreset = new JButton("清空");
			conreset.setBounds(338, 280, 70, 30);
			conreset.setForeground(Color.GREEN);
		    conreset.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {    
		            conreset.setBackground(Color.black);     // 黑色清空
		            concon.setText("");
		            conname.setText("");
		            consex.setText("");
		            concon1.setText("");
		...
		void conductor1() {
			coacreate.setBackground(Color.blue);      // 蓝色提交
            if (concon.getText().equals("") == true && conname.getText().equals("") == true && consex.getText().equals("") == true && concon1.getText().equals("") == true && conname1.getText().equals("") == true && consex1.getText().equals("") == true ) {
            	JOptionPane.showMessageDialog(null, "———— 必填项不可为空 ————", "操作有误", JOptionPane.WARNING_MESSAGE);
			} else if (concon.getText().equals("") == false && conname.getText().equals("") == false && consex.getText().equals("") == true && concon1.getText().equals("") == false && conname1.getText().equals("") == false && consex1.getText().equals("") == true ) {
				JOptionPane.showMessageDialog(null, "———— 性别不可为空 ————", "操作有误", JOptionPane.ERROR_MESSAGE);
				consex.requestFocusInWindow();
			} else if (concon.getText().equals("") == false && conname.getText().equals("") == true && consex.getText().equals("") == false  && concon1.getText().equals("") == false && conname1.getText().equals("") == true && consex1.getText().equals("") ==  false) {
				JOptionPane.showMessageDialog(null, "———— 姓名不可为空 ————", "操作有误", JOptionPane.ERROR_MESSAGE);
				conname.requestFocusInWindow();
			}  else if (concon.getText().equals("") == true && conname.getText().equals("") == false && consex.getText().equals("") == false  && concon1.getText().equals("") == true && conname1.getText().equals("") == false && consex1.getText().equals("") == false ) {
				JOptionPane.showMessageDialog(null, "———— 工号不可为空 ————", "操作有误", JOptionPane.ERROR_MESSAGE);
				concon.requestFocusInWindow();
			} else if (concon.getText().equals("") == false && conname.getText().equals("") == false && consex.getText().equals("") == false && concon1.getText().equals("") == false && conname1.getText().equals("") == false && consex1.getText().equals("") == false ) {
			Statement sm = null;
	        try{ 
	           	Connection con = DriverManager.getConnection(RL,"sa","5436.......");
	           	sm = con.createStatement();
	           	int coa2 = sm.executeUpdate("use 郑烁彬_sj"+"\n"
							...
							+"Cno = \'"+concon1.getText()+"\',"
							+"Cname = \'"+conname1.getText()+"\',"
							+"Csex = \'"+consex1.getText()+"\'"+"\n"
							+"where "
							+"Cno = \'"+concon.getText()+"\' and "
							+"Cname = \'"+conname.getText()+"\' and "
							+"Csex = \'"+consex.getText()+"\';"); 	
	           	if(coa2 == 1){
               	 Object[] options ={"确定"};  //自定义按钮上的文字
               	 JOptionPane.showOptionDialog(null,
	        	...
	        	err.printStackTrace(System.out);
				System.out.println("数据库连接失败！____Conductor！");
	        	}
		} else {
			JOptionPane.showMessageDialog(null, "———— 多处输入有误 ————", "操作结果", JOptionPane.ERROR_MESSAGE);
		}
		...
		public void actionPerformed(ActionEvent e) {
			try {
		        ...
		        if (e.getSource() == ccexit) {
		        	...
		        	dispose();
			        new achpage().setBounds(750,50,592,660);      // 刷新
		        }
		      //菜单栏事件
