...
public class porgr extends JFrame implements ActionListener{
	...
	public porgr() {
    	background = new ImageIcon("D:\\eclipse\\课程设计\\bin\\img\\退票.png");             // 背景图片
	...
	void porgr1() {
		...
		public void actionPerformed(ActionEvent e) {
	        if (e.getSource() == pghome) {
	            ...
	            dispose();
	            new prefund().setBounds(750,50,576,650);
	        }else if (e.getSource() == grouprorb) {
	        	grouprorb.setBackground(Color.yellow);      // 黄色团队
	        	dispose();
	        	new grefund().setBounds(750,50,576,650);
