...
public class afunctionpage extends JFrame implements ActionListener{
	...
	public afunctionpage() {
    	background = new ImageIcon("D:\\eclipse\\课程设计\\bin\\img\\管理员功能页.png");             // 背景图片
